...
| `pnpm run test:integration` | **209 passed**, 18 files, against PostgreSQL 17.10 |
...
| integration | 209   | journal 74, auth 56, migrations 30, CLI 18, worker/executor 12, identity scope 11, API 8                        |

No area's evidence is the workspace total. Module 03's own evidence is the 60 unit and 88
integration cases listed in [docs/handoffs/03.md](handoffs/03.md), and module 04's the 74
